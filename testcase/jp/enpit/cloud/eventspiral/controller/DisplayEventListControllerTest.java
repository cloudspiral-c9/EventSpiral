...
public class DisplayEventListControllerTest {
	...
	public void testExecute04() throws Exception {
		...
		assertEquals(0, newDate(2014, 10, 1, 12, 0, 0).compareTo(events.get(1).getEventDate()));
		assertEquals(0, newDate(2013, 10, 1, 12, 0, 0).compareTo(events.get(1).getTicketStartDate()));
		...
		assertEquals(0, newDate(2014, 10, 1, 12, 1, 0).compareTo(events.get(4).getEventDate()));
		assertEquals(0, newDate(2013, 10, 1, 12, 1, 0).compareTo(events.get(4).getTicketStartDate()));
		...
		assertEquals(0, newDate(2014, 10, 1, 12, 0, 1).compareTo(events.get(2).getEventDate()));
		assertEquals(0, newDate(2013, 10, 1, 12, 0, 1).compareTo(events.get(2).getTicketStartDate()));
		...
		assertEquals(0, newDate(2014, 10, 1, 12, 0, 1).compareTo(events.get(3).getEventDate()));
		assertEquals(0, newDate(2013, 10, 1, 12, 0, 1).compareTo(events.get(3).getTicketStartDate()));
		...
		assertEquals(0, newDate(2015, 6, 1, 12, 0, 0).compareTo(events.get(5).getEventDate()));
		assertEquals(0, newDate(2014, 6, 1, 12, 0, 0).compareTo(events.get(5).getTicketStartDate()));
