...
public class TicketInitializerUCBuyTicket {
	...
	public static void setHost(String host) {
		TicketInitializerUCBuyTicket.host = host;
	}
	 ...
	 * @throws UnknownHostException 接続先ホスト名を解決できない．
	 */
	public static void initDBForbuyTicketsTestUCBuyTickets() throws UnknownHostException {

		DBCollection coll = initTicketColl();
		addTicket(coll, "000000000000000000000001", "event0", "S",
				  newDate(2014,  10,  2,  0,  0,  0),
				  newDate(2014,   8,  2,  0,  0,  0),
				  50000);
		addTicket(coll, "000000000000000000000002", "event0", "A",
				  newDate(2014,  10,  2,  0,  0,  0),
