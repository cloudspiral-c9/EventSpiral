...
public class EventInitializerUCDisplayRegisteredEventList {
    ...
    public static void initDB25Events() throws UnknownHostException {
        ...
        addEvent(coll, "event5", "5", newDate(2014, 10, 1, 5, 0, 0), newDate(2014, 9, 1, 5, 0, 0), "desc5", "promoter1", 100);
        addEvent(coll, "event6", "6", newDate(2014, 10, 1, 6, 0, 0), newDate(2014, 9, 1, 6, 0, 0), "desc6", "promoter1", 100);
