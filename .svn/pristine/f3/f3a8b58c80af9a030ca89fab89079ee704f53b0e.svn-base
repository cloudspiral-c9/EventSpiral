...
public class EventInitializer {
	 ...
	 */
	public static DBCollection initEventColl() throws UnknownHostException {
	...
	public static void initDBForDisplayEventDetailControllerFortestExecute05() throws UnknownHostException {
		DBCollection coll = initEventColl();
	...
	public static void registerSeat(DBCollection coll, String eventId,
			                         String seatName, int fee, int count) {
		...
		List<DBObject> totalSeats = (List<DBObject>) found.get("totalSeats");
		if (totalSeats == null) {
			totalSeats = new ArrayList<DBObject>();
		}
		totalSeats.add(newSeat(seatName,  fee,  count));
	 ...
	 * eventコレクションに1件追加する．
	 */
	public static void addEvent(DBCollection coll,
	...
	public static void initDBForIntegrationTestUCDisplayEventDetail() throws UnknownHostException {
		...
		addEvent(coll,      "000000000000000000000001", "event0", newDate(2014, 10, 2, 0, 0, 0), newDate(2014, 9, 2, 0, 0, 0), "ibento0", "promoter1");
		registerSeat(coll,  "000000000000000000000001",  "S",  50000,  1);
		registerSeat(coll,  "000000000000000000000001",  "A",  10000,  2);
		addEvent(coll,      "000000000000000000000002", "event1", newDate(2014, 10, 3, 0, 0, 0), newDate(2014, 9, 3, 0, 0, 0), "ibento1", "promoter1");
